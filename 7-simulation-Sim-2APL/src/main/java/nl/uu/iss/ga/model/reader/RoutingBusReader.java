...
public class RoutingBusReader {
    ...
    private final HashMap<String, HashMap<String, Double>> waitTimes;
    ...
    public Double getWaitingTime(String location1, String location2) {
        return this.waitTimes.get(location1).get(location2);
    }
    ...
    private void readTravelTimes(File routingFile) {
        ...
        try {
            ...
            while ((line = reader.readNext()) != null) {
                ...
                double waitingTime = Double.parseDouble(line[11].trim());
                ...
                if(this.busTimes.containsKey(departure)) {
                    ...
                    this.waitTimes.get(departure).put(arrival,waitingTime);
                    ...
                    HashMap <String, Double> newBusTimes = new HashMap<String, Double>();
                    newBusTimes.put(arrival, busTime);
                    this.busTimes.put(departure, newBusTimes);

                    HashMap <String, Double> newWaitTimes = new HashMap<String, Double>();
                    newWaitTimes.put(arrival, walkTime);
                    this.waitTimes.put(departure,newWaitTimes);

                    HashMap <String, Double> newBusDistances = new HashMap<String, Double>();
                    newBusDistances.put(arrival, busDistance);
                    this.busDistances.put(departure, newBusDistances);

                    HashMap <String, Double> newWalkTimes = new HashMap<String, Double>();
                    ...
                    HashMap <String, Double> newTotalDistances = new HashMap<String, Double>();
                    newTotalDistances.put(arrival, totalDistance);
