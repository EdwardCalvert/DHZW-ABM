...
public class Simulation {
    ...
    public Simulation(ArgParse arguments) {
        ...
        ModalSelectionPolicyProvider modalSelectionPolicyProvider = new ModalSelectionPolicyProvider(this.config.getModalSelectionStrategy(),this.config.getRandom());

        this.config.createAgents(this.platform, this.environmentInterface, modeOfTransportTracker,utilFunctionProvider, modalSelectionPolicyProvider);
