run_routing_train <- function(
  ...
  df_PC6_Moerwijk <- st_read(pc6_moerwijk_station_shp)
  ...
  routing_train_csv <- file.path(final_output_dir, "routing_train.csv")
  write.csv(df, routing_train_csv, row.names = FALSE)
  return()
}
